...
add_action('wp_ajax_mshare_mo_api_action', 'mshare_mo_api_action');

//register the ajax for non authenticated users
add_action( 'wp_ajax_nopriv_mshare_mo_api_action', 'mshare_mo_api_action' );

// handle the ajax request
function mshare_mo_api_action()
{
